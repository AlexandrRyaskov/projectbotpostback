...
@app.get("/user/registered/{user_id}")
...
@app.get("/user/made_deposit/{user_id}")
...
# http://194.59.247.173:8080/user/registered/{user_id}/?{sub1}=tg_user_id?password=dsjfbsdlkhfldshfhwdsfgjsdjf2189372189743124675136$$$newsflash
